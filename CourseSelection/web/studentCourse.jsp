                                        ...
                                        <c:forEach var="j" begin="1" end="7">
                                            <td>
                                                ...
                                                <c:forEach var="course" items="${StudentCourses}">
                                                    <!-- 判断课程是否符合当前节次和星期 -->
                                                    <c:if test="${course.startTime == i && course.dayOfWeek == j}">
                                                        <div class="bg-light border p-1 mb-1">
                                                                ${course.cName} ${course.weekRange}(${course.weekType})
                                                        </div>
