                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="/UserServlet?action=update" method="post">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="Password" placeholder="New Password" name="Password" required="required">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="Re Password" class="col-sm-3 col-form-label">确认你的新密码</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="Re Password" placeholder="Re Password" name="rePassword" required="required">
                                </div>
                            </div>
