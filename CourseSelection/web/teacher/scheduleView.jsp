                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-description"></p>
                            <form action="/TeacherCourseServlet" role="form" method="post">
                                    ...
                                    <c:forEach var="dayOfWeek" items="${[1,2,3,4,5,6,7]}">
                                        <td>
                                            <c:forEach items="${TeacherCourses}" var="tc">
                                                <!-- 判断课程时间和节次是否匹配 -->
                                                <c:if test="${tc.time == course.startTime && tc.dayOfWeek == dayOfWeek}">
                                                    ${tc.CName}@${tc.DName}(${tc.startWeek}-${tc.endWeek})
                                                    ${tc.TName}
                                                </c:if>
                                            </c:forEach>
                                        </td>
